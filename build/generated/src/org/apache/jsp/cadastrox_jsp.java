...
public final class cadastrox_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <link rel=\"stylesheet\" href=\"../tela-cadastro/css/style.css\">\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("    \n");
      out.write("    <div id=\"main-container\">   <!-- criando um container para o formulario -->\n");
      out.write("        \n");
      out.write("        <p class=\"text-center\"><img src=\"../tela-cadastro/img/EscritaEcomerce.png\" align=\"center\" alt=\"logo-ecommerce2\" width=270px height=50px></p>\n");
      out.write("        <h1>Register to access the system</h1>\n");
      out.write("        \n");
      out.write("        <form id=\"register-form\"> <!-- criando o formulário -->\n");
      out.write("            \n");
      out.write("            <div class=\"full-box\"> <!-- criando um formulário para o email -->\n");
      out.write("                <label for=\"email\">E-mail</label>\n");
      out.write("                <input type=\"email\" name=\"email\" id=\"email\" placeholder=\"Enter your email\" data-min-length=\"3\" date-required>   <!-- o nome do imput deve ser igual ao for da label -->\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <div class=\"half-box spacing\">  <!-- criando um formulário para o nome -->\n");
      out.write("                <label for=\"name\">Name</label>\n");
      out.write("                <input type=\"text\" name=\"name\" id=\"name\" placeholder=\"Enter your name\" data-max-length=\"16 \">   <!-- o nome do imput deve ser igual ao for da label -->\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <div class=\"half-box\">  <!-- criando um formulário para o sobrenome -->\n");
      out.write("                <label for=\"lastname\">Lastname</label>\n");
      out.write("                <input type=\"text\" name=\"lastname\" id=\"lastname\" placeholder=\"Enter your lastname\">   <!-- o nome do imput deve ser igual ao for da label -->\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <div class=\"half-box spacing\">  <!-- criando um formulário para o password -->\n");
      out.write("                <label for=\"password\">Password</label>\n");
      out.write("                <input type=\"password\" name=\"password\" id=\"password\" placeholder=\"Enter your password\">   <!-- o nome do imput deve ser igual ao for da label -->\n");
      out.write("            </div>\n");
      out.write("\n");
